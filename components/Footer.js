function Footer() {
    return (
        <footer className="bg-[#F2F6FC] dark:bg-[#404040] dark:text-[#f3f3f3] max-w-full p-3 shadow-[rgba(0,0,0,0.02)_0px_1px_3px_0px,rgba(27,31,35,0.15)_0px_0px_0px_1px] flex ">
